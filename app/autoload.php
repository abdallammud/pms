    ...
    return [
        ...
        'tenants' => [
            ...
            'sub' => [
                ...
                'leases' => ['default' => 'leases', 'route' => 'leases', 'active' => ['leases', 'edit_lease', 'view_lease'], 'name' => 'Lease Directory', 'auth' => 'lease_manage'],
                'add_lease' => ['default' => 'add_lease', 'route' => 'add_lease', 'is_menu' => false, 'name' => 'Add Lease', 'auth' => 'lease_create'],
                'edit_lease' => ['default' => 'edit_lease', 'is_menu' => false, 'route' => 'edit_lease', 'name' => 'Edit Lease', 'auth' => 'lease_update'],
                'view_lease' => ['default' => 'view_lease', 'is_menu' => false, 'route' => 'view_lease', 'name' => 'View Lease', 'auth' => 'lease_manage'],
