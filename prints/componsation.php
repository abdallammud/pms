...
$y += 6;
$pdf->SetXY(70, $y);
$pdf->Cell(130, 7, strtoupper("Componsation and Benfits Reports"), 0, 0, 'R');
...
$pdf->Cell(23, 7, "Base salary", 1, 0, 'L', true);
$pdf->Cell(23, 7, "Allowance", 1, 0, 'L', true);
$pdf->Cell(23, 7, "Bonus", 1, 0, 'L', true);
$pdf->Cell(23, 7, "Deductions", 1, 0, 'L', true);
$pdf->Cell(23, 7, "Net pay", 1, 1, 'L', true);
...
if ($employees->num_rows > 0) {
    while ($row = $employees->fetch_assoc()) {
		...
		$pdf->Cell(23, 7, formatMoney($base_salary), 1, 0, 'L', 0);
		$pdf->Cell(23, 7, formatMoney($allowance), 1, 0, 'L', 0);
		$pdf->Cell(23, 7, formatMoney($bonus), 1, 0, 'L', 0);
        $pdf->Cell(23, 7, formatMoney($total_deductions), 1, 0, 'L', 0);
		$pdf->Cell(23, 7, formatMoney($net_salary), 1, 1, 'L', 0);
