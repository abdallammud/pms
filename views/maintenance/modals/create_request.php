            ...
            <form id="saveRequestForm">
                ...
                <div class="modal-body modal-scroll-force">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 multiselect-parent">
                                        <label class="form-label fw-semibold multiselect-label">Unit <span
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-2" id="priority_buttons">
                                            ...
                                            <button type="button"
                                                class="btn btn-outline-success btn-sm flex-fill priority-btn"
                                                data-val="low">
                                                <i class="bi bi-arrow-down-circle me-1"></i>Low
                                            </button>
                                            <button type="button"
                                                class="btn btn-warning btn-sm flex-fill priority-btn active"
                                                data-val="medium">
                                                <i class="bi bi-dash-circle me-1"></i>Medium
                                            </button>
                                            <button type="button"
                                                class="btn btn-outline-danger btn-sm flex-fill priority-btn"
                                                data-val="high">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Requester Name <span
                                                class="text-danger">*</span></label>
                                        <div class="input-group">
                                            ...
                                            <button type="button" class="btn btn-outline-secondary"
                                                id="clearRequesterBtn" title="Clear auto-fill"><i
                        ...
                        <div class="col-12">
                            <label class="form-label fw-semibold">Description of Issue <span
                                    class="text-danger">*</span></label>
