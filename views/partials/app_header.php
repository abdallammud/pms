...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?= baseUri(); ?>/public/plugins/select2/css/select2.min.css">
  <link rel="stylesheet" type="text/css" href="<?= baseUri(); ?>/public/plugins/select2/css/select2-bootstrap4.css">
  <!--bootstrap css-->
